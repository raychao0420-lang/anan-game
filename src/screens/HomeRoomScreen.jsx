...
const DECO_ACTIVITIES = {
  ...
  telescope:   { pets: ['owl', 'mejiro', 'jiji', 'raccoon', 'twinkle', 'luna', 'pluto'], motion: 'gaze', emoji: '🌟' },
  ...
  fairy_light: { pets: ['raccoon', 'monkey', 'mejiro', 'jiji', 'twinkle', 'luna', 'pluto'], motion: 'gaze', emoji: '✨' },
