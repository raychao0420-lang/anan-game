...
export default function MultiplyScreen({ onBack }) {
  const { activePet, pets, petEquipment, multiplyCleared, clearMultiply } = useGameStore()
  ...
  }, [phase, feedback, input, currentQ, qIdx, roundIdx, round, multiplyCleared, clearMultiply])
